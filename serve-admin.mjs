...
const siteRoot = path.join(root, 'www.playkagama.xyz');
...
<link rel="icon" href="/www.playkagama.xyz/static/img/kogama-logo.webp" type="image/webp">
...
<header id="pageheader"><div class="pageheader-inner"><a href="/www.playkagama.xyz/games/" title="PlayKaGaMa" class="logo"><div class="logo-image"></div></a><nav class="menu anonymous"><ol><li class="game "><a href="/www.playkagama.xyz/games/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M21 6H3c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-10 7H8v3H6v-3H3v-2h3V8h2v3h3v2zm4.5 2c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zm4-3c-.83 0-1.5-.67-1.5-1.5S18.67 9 19.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/></svg><span class="text">Play</span></a></li><li class="shop active"><a href="/www.playkagama.xyz/marketplace/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg><span class="text">Shop</span></a></li><li class="news "><a href="/www.playkagama.xyz/news/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"/></svg><span class="text">News</span></a></li></ol></nav><div id="account-header"></div></div></header>
...
async function resolveFilePath(rawPathname) {
  ...
  if (relativePath && !relativePath.startsWith('www.playkagama.xyz/')) {
    candidates.push(path.join('www.playkagama.xyz', relativePath));
  }
    ...
    if (!relativePath.startsWith('www.playkagama.xyz/')) {
      candidates.push(path.join('www.playkagama.xyz', `${relativePath}.html`));
      candidates.push(path.join('www.playkagama.xyz', relativePath, 'index.html'));
    }
  }
...
function injectOverrides(html) {
  if (html.includes('/www.playkagama.xyz/static/local/offline-overrides.js') || html.includes('/www.playkagama.xyz/static/local/offline-overrides.js')) {
    return html;
  }

  html = html.replace(/"\.\.\/\.\.\/www\.kogama\.com\//g, '"/www.playkagama.xyz/');
  html = html.replace(/'\.\.\/\.\.\/www\.kogama\.com\//g, "'/www.playkagama.xyz/");
  ...
  const injection = [
    '<link rel="stylesheet" href="/www.playkagama.xyz/static/local/offline-overrides.css">',
    '<script defer src="/www.playkagama.xyz/static/local/offline-overrides.js"></script>',
  ].join('');
...
function fallbackPage(rawPathname) {
  ...
  if (profileMatch) {
    ...
    if (profileId === '668677211') {
      return shellPage({
        ...
        primaryHref: '/www.playkagama.xyz/profile/1/index.html',
  ...
  if (gameMatch) {
    return shellPage({
      ...
      primaryHref: '/www.playkagama.xyz/games/index.html',
  ...
  if (modelMatch) {
    return shellPage({
      ...
      primaryHref: '/www.playkagama.xyz/marketplace/index.html',
  ...
  if (pathname.startsWith('/news/')) {
    return shellPage({
      ...
      primaryHref: '/www.playkagama.xyz/news/index.html',
  ...
  if (pathname.startsWith('/videos/')) {
    return shellPage({
      ...
      primaryHref: '/www.playkagama.xyz/videos/index.html',
...
function normalizeArchivePath(rawPathname) {
  ...
  if (pathname.startsWith('/www.playkagama.xyz')) {
    pathname = pathname.slice('/www.playkagama.xyz'.length) || '/';
  } else if (pathname.startsWith('/www.kogama.com')) {
...
<body>
  <header id="pageheader">
    <div class="pageheader-inner">
      <a href="/www.playkagama.xyz/games/index.html" title="PlayKaGaMa" class="logo"><div class="logo-image"></div></a>
      <nav><a href="/www.playkagama.xyz/games/index.html">Play</a><a href="/www.playkagama.xyz/marketplace/index.html">Shop</a><a href="/www.playkagama.xyz/news/index.html">News</a><a href="/www.playkagama.xyz/videos/index.html">Videos</a></nav>
